<header class="header" id="header">
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    <li class="nav__item">
                        <a href="#home" class="nav__link link">Главная</a>
                    </li>
                    <li class="nav__item">
                        <a href="#portfolio" class="nav__link link">Портфолио</a>
                    </li>
                    <li class="nav__item">
                        <a href="#services" class="nav__link link">Услуги</a>
                    </li>
                    <li class="nav__item">
                        <a href="#contact" class="nav__link link">Контакты</a>
                    </li>
                    <li class="nav__item">
                        <a href="/сайт/registration.php" class="nav__link link">Войти</a>
                    </li>
                </ul>
